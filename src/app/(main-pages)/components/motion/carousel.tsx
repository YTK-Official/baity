...
import { type Transition, motion, useMotionValue } from 'framer-motion';
...
function CarouselNavigation({ className, classNameButton, alwaysShow }: CarouselNavigationProps) {
  ...
  return (
    <div
      className={cn(
        '-translate-y-1/2 pointer-events-none absolute top-1/2 left-[-12.5%] flex w-[125%] justify-between px-2',
        className,
      )}
    >
      <button
